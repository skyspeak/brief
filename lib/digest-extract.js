...
- Max 3 talking_points and 3 stats (do not pad).
- Exactly 5 persona_insights (one per role key).
- Max 20 words per text field — shorten fields rather than omitting keys.
- The JSON must end with a closing brace — never stop mid-string.`;
